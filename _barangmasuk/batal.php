        ...
        if( batal($_POST) > 0){
            ...
            echo "
                    <script>
                        ...
                        document.location.href = 'batal.php';
                    </script>
                ";
        }
    }
                    ...
                    <div class="box">
                        <h2>Form Pembatalan Data</h2>
                            <form action="" method="post" class="form form-control-static">
                                ...
                                <input type="hidden" name="id_barangmasuk" id="id_barangmasuk" value="<?= $dbm["id_brgmasuk"]; ?>"><br>                 
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                            <input type="text" name="kode_barangmasuk" id="kode_barangmasuk" class="form-control" style="font-size: 18px;" autocomplete="off" required readonly value="<?= $dbm["kode_barang"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <input type="hidden" name="satuan" id="satuan" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $dbm["id_satuan"]; ?>" readonly>

                                    <input type="hidden" name="kategori" id="kategori" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $dbm["id_kategori"]; ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                            <input type="text" name="supplier" id="supplier" class="form-control" style="font-size: 18px;" autocomplete="off" required readonly value="<?= $dbm["nama"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <center>
                                    <button type="submit" name="submit" class="btn btn-info" style="margin-left: 550px;"><span class="fas fa-save"> Selesai</span></button>
