...
$pdf->Cell(50,5,'Laporan Data Keluar','0','1','L',false);
$pdf->Ln(3);
...
$pdf->Cell(34,6,'Nama Customer',1,0,'C');
$pdf->Cell(20,6,'Jml Masuk',1,0,'C');
$pdf->Cell(30,6,'Keterangan',1,0,'C');
$pdf->Ln(2);

$no = 0;
$sql= mysqli_query($conn,"SELECT * FROM tbl_datakeluar ORDER BY id_datakeluar DESC");
while ($data = mysqli_fetch_array($sql)) {
    ...
    $pdf->Cell(34,4,$data['customer'],1,0,'L');
    $pdf->Cell(20,4,$data['jml_keluar'],1,0,'C');
