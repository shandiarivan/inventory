<?php 
    ...
    $trk = query("SELECT A.*, B.nama_customer FROM tbl_transitkeluar AS A INNER JOIN customer AS B ON (A.id_customer = B.id_customer) WHERE id_trkeluar = $id")[0];
                    ...
                    <div class="box">
                        <h2>Konfirmasi Pembatalan</h2>
                            <form action="" method="post" class="form form-control-static">
                                <div class="container">
                                <input type="hidden" name="id_trkeluar" id="id_trkeluar" value="<?= $trk["id_trkeluar"]; ?>">
                                <input type="hidden" class="form-control" name="id_barangmasuk" id="id_barangmasuk" value="<?= $trk["id_brgmasuk"]; ?>">
                                <input type="hidden" name="id_barangkeluar" id="id_barangkeluar" value="<?= $trk["id_brgkeluar"]; ?>">                 
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="kode_barangkeluar" id="kode_barangkeluar" class="form-control" style="font-size: 18px;" autocomplete="off" required readonly value="<?= $trk["kode_barang"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="nama_barang" id="nama_barang" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $trk["nama_barang"]; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="tgl_keluar" id="tgl_keluar" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $trk["tgl_keluar"]; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    
                                    <input type="hidden" name="stok_awal" id="stok_awal" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $trk["stok_awal"]; ?>" readonly>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="jml_keluar" id="jml_keluar" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $trk["jml_keluar"]; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                            <input type="text" name="customer" id="customer" class="form-control" style="font-size: 18px;" autocomplete="off" required value="<?= $trk["nama_customer"]; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
