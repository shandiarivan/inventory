...
<head>
    ...
    <link rel="stylesheet" href="dist/css/box.css">
                ...
                <ul class="menu-content">
                    ...
                    <li>
                        ...
                        <ul>
                            ...
                            <li>
                                <a href="_laporanbk/laporan_bk"> Laporan Barang Keluar</a>
                            </li>
                            <li>
                                <a href="_laporansm/laporan_sm"> Laporan Stok Masuk</a>
                            </li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="logout.php" onclick="return confirm('Yakin Untuk Keluar?')"><span style="color: red;"><i class="fas fa-sign-out-alt"></i> Logout</span></a>
                    </li>
