<?php 
    ...
    $cus = query("SELECT * FROM customer WHERE id_customer = $id ")[0];
                    ...
                    <div class="box">
                        <h2>Edit Data Customer</h2>
                            <form action="" method="post" class="form form-control-static">
                                <div class="container">
                                <input type="hidden" name="id_customer" value="<?= $cus["id_customer"]; ?>">
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="nama_customer" id="nama_customer" class="form-control" placeholder="Masukkan Nama Customer" style="font-size: 18px;" autocomplete="off" required value="<?= $cus["nama_customer"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="email" id="email" class="form-control" placeholder="Masukkan Email" style="font-size: 18px;" autocomplete="off" required value="<?= $cus["email"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <input type="text" name="telepon" id="telepon" class="form-control" placeholder="Masukkan Nomor Telepon" onkeypress="return angka(event)" style="font-size: 18px;" maxlength="13" autocomplete="off" value="<?= $cus["telepon"]; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-md-5">
                                                <textarea type="text" name="alamat" id="alamat" class="form-control" rows="3" placeholder="Masukkan Alamat" autocomplete="off" style="font-size: 18px;" required><?= $cus["alamat"] ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <center>
                                    ...
                                    <a href="customer.php" class="btn btn-danger">Kembali</a>
                                </center>
                            </form>
                    </div>
                </div>
